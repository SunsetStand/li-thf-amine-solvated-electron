...
REQUIREMENT_ENGINES: dict[str, tuple[str, ...]] = {
    ...
    "classical_md": ("git", "snakemake", "packmol", "ambertools", "gromacs"),
    "cdft": ("git", "snakemake", "cp2k"),
    "embedded_vde": ("git", "snakemake", "orca"),
    "plane_wave_gate": ("git", "snakemake", "quantum_espresso"),
